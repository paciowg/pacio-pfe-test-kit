...
module PacioPFETestKit
  module PacioPFEV300_BALLOT
    class ServiceRequestValidationTest < Inferno::Test
      ...
      id :pfe_v300_ballot_service_request_validation_test

      title <<~DESC
        ServiceRequest resources returned during previous tests conform to the Personal Functioning and Engagement Service Request Profile
      DESC
