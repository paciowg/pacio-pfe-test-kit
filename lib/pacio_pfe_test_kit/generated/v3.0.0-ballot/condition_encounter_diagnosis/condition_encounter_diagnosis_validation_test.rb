...
module PacioPFETestKit
  module PacioPFEV300_BALLOT
    class ConditionEncounterDiagnosisValidationTest < Inferno::Test
      ...
      id :pfe_v300_ballot_condition_encounter_diagnosis_validation_test

      title <<~DESC
        Condition resources returned during previous tests conform to the Personal Functioning and Engagement Condition Encounter Diagnosis Profile
      DESC
