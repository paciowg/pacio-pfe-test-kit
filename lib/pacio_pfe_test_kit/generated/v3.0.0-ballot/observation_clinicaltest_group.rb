...
read succeeds.
      ...
      id :pfe_v300_ballot_observation_clinicaltest
      run_as_group
      ...
      test from: :pfe_v300_ballot_observation_clinicaltest_patient_code_search_test
      test from: :pfe_v300_ballot_observation_clinicaltest_patient_category_date_search_test
      test from: :pfe_v300_ballot_observation_clinicaltest_patient_category_search_test
      test from: :pfe_v300_ballot_observation_clinicaltest_read_test
      test from: :pfe_v300_ballot_observation_clinicaltest_validation_test
      test from: :pfe_v300_ballot_observation_clinicaltest_must_support_test
    end
  end
end
