...
module PacioPFETestKit
  module PacioPFEV300_BALLOT
    class NutritionOrderPatientSearchTest < Inferno::Test
      include PacioPFETestKit::SearchTest

      title 'Server returns valid results for NutritionOrder search by patient'
      description %(
A server SHALL support searching by
patient on the NutritionOrder resource. This test
...
[PACIO PFE Server CapabilityStatement](/CapabilityStatement-pfe.html)
      ...
      id :pfe_v300_ballot_nutrition_order_patient_search_test
      optional
