...
read succeeds.
      ...
      id :pfe_v300_ballot_nutrition_order
      run_as_group
      ...
      test from: :pfe_v300_ballot_nutrition_order_patient_search_test
      test from: :pfe_v300_ballot_nutrition_order_read_test
      test from: :pfe_v300_ballot_nutrition_order_validation_test
      test from: :pfe_v300_ballot_nutrition_order_must_support_test
    end
  end
end
