...
module PacioPFETestKit
  module PacioPFEV300_BALLOT
    class ConditionProblemsHealthConcernsPatientCategorySearchTest < Inferno::Test
...
[PACIO PFE Server CapabilityStatement](/CapabilityStatement-pfe.html)
      ...
      id :pfe_v300_ballot_condition_problems_health_concerns_patient_category_search_test
      input :patient_ids,
            title: 'Patient IDs',
