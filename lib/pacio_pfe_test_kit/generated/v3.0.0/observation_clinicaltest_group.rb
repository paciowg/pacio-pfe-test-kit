...
read succeeds.
      ...
      id :pfe_v300_observation_clinicaltest
      run_as_group
      ...
      test from: :pfe_v300_observation_clinicaltest_validation_test
      test from: :pfe_v300_observation_clinicaltest_must_support_test
    end
  end
end
