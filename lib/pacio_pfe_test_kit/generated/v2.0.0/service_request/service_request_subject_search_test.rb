...
module PacioPFETestKit
  module PacioPFEV200
    class ServiceRequestSubjectSearchTest < Inferno::Test
      include PacioPFETestKit::SearchTest

      title 'Server returns valid results for ServiceRequest search by subject'
      description %(
A server SHALL support searching by
subject on the ServiceRequest resource. This test
