...
read succeeds.
      ...
      id :pfe_v300_ballot_service_request
      run_as_group
      ...
      test from: :pfe_v300_ballot_service_request_patient_search_test
      test from: :pfe_v300_ballot_service_request__id_search_test
      test from: :pfe_v300_ballot_service_request_patient_category_authored_search_test
      test from: :pfe_v300_ballot_service_request_patient_category_search_test
      test from: :pfe_v300_ballot_service_request_patient_code_search_test
      test from: :pfe_v300_ballot_service_request_read_test
      test from: :pfe_v300_ballot_service_request_validation_test
      test from: :pfe_v300_ballot_service_request_must_support_test
    end
  end
end
