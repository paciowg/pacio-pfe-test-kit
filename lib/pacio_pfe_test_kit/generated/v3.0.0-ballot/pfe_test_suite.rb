...
require_relative '../../custom_groups/v3.0.0-ballot/capability_statement_group'
...
module PacioPFETestKit
  module PacioPFEV300_BALLOT
    class PacioPFETestSuite < Inferno::TestSuite
      title 'PACIO PFE Server v3.0.0-ballot'
      description %(
      ...
      fhir_resource_validator do
        igs 'hl7.fhir.us.pacio-pfe#3.0.0-ballot', 'hl7.fhir.us.core#9.0.0'
      ...
      group from: :pfe_v300_ballot_capability_statement

      group from: :pfe_v300_ballot_patient
      group from: :pfe_v300_ballot_condition_encounter_diagnosis
      group from: :pfe_v300_ballot_condition_problems_health_concerns
      group from: :pfe_v300_ballot_device
      group from: :pfe_v300_ballot_device_request
      group from: :pfe_v300_ballot_device_use_statement
      group from: :pfe_v300_ballot_diagnostic_report
      group from: :pfe_v300_ballot_goal
      group from: :pfe_v300_ballot_nutrition_order
      group from: :pfe_v300_ballot_observation_clinicaltest
      group from: :pfe_v300_ballot_observation_collection
      group from: :pfe_v300_ballot_observation_single
      group from: :pfe_v300_ballot_service_request
