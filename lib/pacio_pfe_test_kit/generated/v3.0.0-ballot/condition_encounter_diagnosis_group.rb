...
read succeeds.
      ...
      id :pfe_v300_ballot_condition_encounter_diagnosis
      run_as_group
      ...
      test from: :pfe_v300_ballot_condition_encounter_diagnosis_patient_search_test
      test from: :pfe_v300_ballot_condition_encounter_diagnosis_patient_category_search_test
      test from: :pfe_v300_ballot_condition_encounter_diagnosis_read_test
      test from: :pfe_v300_ballot_condition_encounter_diagnosis_validation_test
      test from: :pfe_v300_ballot_condition_encounter_diagnosis_must_support_test
    end
  end
end
