...
read succeeds.
      ...
      id :pfe_v300_ballot_diagnostic_report
      run_as_group
      ...
      test from: :pfe_v300_ballot_diagnostic_report_patient_search_test
      test from: :pfe_v300_ballot_diagnostic_report_patient_category_date_search_test
      test from: :pfe_v300_ballot_diagnostic_report_patient_category_search_test
      test from: :pfe_v300_ballot_diagnostic_report_patient_code_search_test
      test from: :pfe_v300_ballot_diagnostic_report_read_test
      test from: :pfe_v300_ballot_diagnostic_report_validation_test
      test from: :pfe_v300_ballot_diagnostic_report_must_support_test
    end
  end
end
