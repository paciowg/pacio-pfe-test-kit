...
module PacioPFETestKit
  module PacioPFEV200
    class PfeConditionProblemsHealthConcernsPatientCategorySearchTest < Inferno::Test
...
[PACIO PFE Server CapabilityStatement](/CapabilityStatement-pfe.html)
      ...
      id :pfe_v200_condition_problems_health_concerns_patient_category_search_test
      input :patient_ids,
            title: 'Patient IDs',
