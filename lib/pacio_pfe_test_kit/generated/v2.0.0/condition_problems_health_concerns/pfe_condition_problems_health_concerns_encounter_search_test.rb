...
module PacioPFETestKit
  module PacioPFEV200
    class PfeConditionProblemsHealthConcernsEncounterSearchTest < Inferno::Test
      include PacioPFETestKit::SearchTest

      title 'Server returns valid results for Condition search by encounter'
      description %(
...
[PACIO PFE Server CapabilityStatement](/CapabilityStatement-pfe.html)
      ...
      id :pfe_v200_condition_problems_health_concerns_encounter_search_test
      optional
