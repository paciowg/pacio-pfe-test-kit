...
read succeeds.
      ...
      test from: :pfe_v300_device_patient_search_test
      test from: :pfe_v300_device_read_test
      test from: :pfe_v300_device_validation_test
      test from: :pfe_v300_device_must_support_test
    end
  end
end
