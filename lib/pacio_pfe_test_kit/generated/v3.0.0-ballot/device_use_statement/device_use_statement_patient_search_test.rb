...
module PacioPFETestKit
  module PacioPFEV300_BALLOT
    class DeviceUseStatementPatientSearchTest < Inferno::Test
      include PacioPFETestKit::SearchTest

      title 'Server returns valid results for DeviceUseStatement search by patient'
      description %(
A server SHALL support searching by
patient on the DeviceUseStatement resource. This test
...
requirement of PACIO PFE v3.0.0-ballot.

[PACIO PFE Server CapabilityStatement](/CapabilityStatement-pfe.html)

      )

      id :pfe_v300_ballot_device_use_statement_patient_search_test
      optional
